...
class CoinMarketParser:
    ...
    def get_name(self):
        ...
        """
        crypto_name = self.htmlElement.find_element(
    ...
    def get_price(self):
        ...
        """
        crypto_price = self.htmlElement.find_element(
    ...
    def get_one_hour_change(self):
        ...
        """
        crypto_one_hour_change = self.htmlElement.find_element(
    ...
    def get_one_day_change(self):
        ...
        """
        crypto_one_day_change = self.htmlElement.find_element(
    ...
    def get_one_week_change(self):
        ...
        """
        crypto_one_week_change = self.htmlElement.find_element(
            By.CSS_SELECTOR, "td:nth-of-type(7)"
        )
    ...
    def get_market_cap(self):
        ...
        """
        crypto_market_cap = self.htmlElement.find_element(
    ...
    def get_volume(self):
        ...
        """
        crypto_volume = self.htmlElement.find_element(
            By.CSS_SELECTOR, "td:nth-of-type(9)"
        )
    ...
    def get_circulating_supply(self):
        ...
        """
        crypto_circulating_supply = self.htmlElement.find_element(
            By.CSS_SELECTOR, "td:nth-of-type(10)"
        )
